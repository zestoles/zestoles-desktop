...
1. Değişiklik için ayrı bir dal açın.
2. Kişisel veri, model ağırlığı, `.env`, veritabanı, günlük, ses kaydı veya bot
   anahtarı eklemeyin.
3. `python -m unittest discover -s tests` komutunu çalıştırın.
4. Yetki, ağ, dosya sistemi veya komut çalıştırma değişikliklerinde tehdit modelini
